...
import { useActiveCharacterAvatarUrl } from "../../hooks/useActiveCharacterPack";
        ...
        <div className="moments-composer__mention-picker" role="listbox">
          {candidates.length === 0 ? (
            ...
            candidates.map((name, index) => {
              ...
              // "昔涟"这个自身角色的头像改走当前生效角色包，而不是固定的头像池条目
              const avatar = isCyrene ? activeCharacterAvatarUrl : getCharacterAvatar(name);
              return (
                <button
                  type="button"
                  key={name}
