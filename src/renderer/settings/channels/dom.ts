...
export const channelsDiscordBotTokenEl = document.getElementById("channels-discord-bot-token") as HTMLInputElement | null;
export const channelsDiscordAllowAnyDmEl = document.getElementById("channels-discord-allow-any-dm") as HTMLInputElement | null;
export const channelsDiscordUserAllowlistEl = document.getElementById("channels-discord-user-allowlist") as HTMLTextAreaElement | null;
export const channelsDiscordGuildAllowlistEl = document.getElementById("channels-discord-guild-allowlist") as HTMLTextAreaElement | null;
