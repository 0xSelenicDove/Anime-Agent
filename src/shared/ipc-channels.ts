...
export const IPC = {
  ...
  CHARACTER_PACKS_LIST: "character-packs:list",
  CHARACTER_PACKS_GET_ACTIVE: "character-packs:get-active",
  CHARACTER_PACKS_CHANGED: "character-packs:changed",
  CHARACTER_PACKS_PICK_ZIP: "character-packs:pick-zip",
  CHARACTER_PACKS_IMPORT_ZIP: "character-packs:import-zip",
  CHARACTER_PACKS_DELETE: "character-packs:delete",
