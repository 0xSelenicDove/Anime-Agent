...
import { getActiveCharacterDisplayName } from "../character-packs/character-pack-registry";
...
export function createReactChatWindowShell(): BrowserWindow {
  ...
  const window = new BrowserWindow({
    ...
    minWidth: 960,
    minHeight: 540,
    title: `${getActiveCharacterDisplayName()} · 聊天`,
...
export function createSidebarWindow(): void {
  ...
  const window = new BrowserWindow({
    ...
    minWidth: 56,
    minHeight: 540,
    title: `${getActiveCharacterDisplayName()} · 状态`,
    icon: getCurrentAppIconPath(),
    backgroundColor: "#00000000",
    autoHideMenuBar: true,
    show: false,
...
export function createTasksWindow(): void {
  ...
  const window = new BrowserWindow({
    ...
    height: 760,
    minHeight: 540,
    title: `${getActiveCharacterDisplayName()} · 今日日程`,
    icon: getCurrentAppIconPath(),
    backgroundColor: "#00000000",
    autoHideMenuBar: true,
    show: false,
...
export function createSettingsWindow(section?: string): void {
  ...
  const window = new BrowserWindow({
    ...
    minWidth: 920,
    minHeight: 580,
    title: `${getActiveCharacterDisplayName()} · 设置`,
    icon: getCurrentAppIconPath(),
    backgroundColor: "#00000000",
    autoHideMenuBar: true,
    show: false,
...
export function createCallWindow(): void {
  ...
  const window = new BrowserWindow({
    ...
    minWidth: 420,
    minHeight: 600,
    title: `${getActiveCharacterDisplayName()} · 语音通话`,
    icon: getCurrentAppIconPath(),
    backgroundColor: "#00000000",
    autoHideMenuBar: true,
    show: false,
